...
The Code Snippets are provided here. The code snippets for the **_three different models_** are provided. This folder must be opened when the person wants to have an
**_abstract knowledge_** of the project and the Models developed.
